...
export default class Transaction extends React.Component<IProps, IState> {
    ...
    onChange = (
        ...
        let sourceArr: IGetTransactionResponse[] =
    ...
    calculateTotalAmount = (
        sourceArr: Array<IGetTransactionResponse>
    ): void => {
    ...
    render() {
        ...
        const columns: ColumnsType<IGetTransactionResponse> = [
            ...
            },
            {
                ...
                render: (text, record, index) => {
                    let category = Constants.CATEGORIES.filter(
                        (i) => i.name === text
                    )[0];
                    return category ? (
                    ...
                    <Popconfirm
                        ...
                        onConfirm={() => {
                            revertTransaction(record.transaction_id)
                                ...
                                .catch((err) =>
                                    console.log(
                                        "err While reverting transaction: " +
            ...
            <div>
                {this.state.windowWidth <= 480 ? (
                    <Empty
                        ...
                        description={
                            <span>Potrait Screen is not supportted</span>
                        }
                    >
                    ...
                    <div onMouseDown={(e) => e.preventDefault()}>
                        <Table
                            ...
                            dataSource={
                                tableProps.hasData ? this.state.tableData : []
                            }
                            scroll={scroll}
